...
export const Menu = () => {
  ...
  return (
    <Wrapper setIsExpanded={setIsExpanded}>
      <>
...
const Wrapper = ({
  ...
  const sharedStyles =
    'bg-black border-b lg:border-b-0 lg:border-r border-white shrink-0 flex flex-row lg:flex-col w-full max-h-50 lg:max-h-full justify-between'
